...
export const slides: Slide[] = [
  ...
  { kicker: '02 · EVOLUÇÃO', title: 'De 2013 à React Foundation', statement: 'A arquitetura evoluiu sem abandonar o modelo de componentes.', bullets: ['2013 · lançamento público', '2017 · Fiber', '2019 · Hooks', '2022 · React 18', '2024 · React 19', '2026 · Foundation + 19.3'], source: 'react.dev/versions · react.dev/blog/2026/02/24' },
  ...
  { kicker: '11 · SEGURANÇA', title: 'CVE-2025-55182 exige atualização imediata', statement: 'Execução remota não autenticada em React Server Components. CVSS 10.0.', bullets: ['Afetadas: 19.0.0, 19.1.0, 19.1.1 e 19.2.0', 'Pacotes react-server-dom-*', 'Correções: 19.0.1, 19.1.2 e 19.2.1', 'Atualizar framework, pacotes e rebuild', 'Este Vite client-side, sem RSC, não é afetado diretamente'], source: 'react.dev/blog/2025/12/03/critical-security-vulnerability-in-react-server-components' },
